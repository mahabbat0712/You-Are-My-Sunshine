...
public class WebConfig implements WebMvcConfigurer {
    ...
    /**
     * Configure Thymeleaf template resolver for views
     */
    @Bean
    ...
    /**
     * Configure Thymeleaf template resolver for templates
     */
    @Bean
    ...
    public SpringTemplateEngine templateEngine() {
        ...
        // Add Layout dialect for Thymeleaf
        templateEngine.addDialect(new nz.net.ultraq.thymeleaf.layoutdialect.LayoutDialect());
        logger.info("Added Layout Dialect for Thymeleaf templates");
        
        return templateEngine;
    }
    
    /**
     * Configure ClassLoader template resolver for classpath resources
     */
    @Bean
    public ClassLoaderTemplateResolver classLoaderTemplateResolver() {
        ...
        logger.info("Configured ClassLoaderTemplateResolver");
        return resolver;
    }
