...
/**
 * Controller for handling admin user operations at /admin/users/* endpoints
 */
@Controller
@RequestMapping("/admin/users")
public class AdminUsersController {
    private static final Logger logger = LogManager.getLogger(AdminUsersController.class);
    
    private final UserService userService;
    private final SessionService sessionService;
    
    @Autowired
    public AdminUsersController(UserService userService, SessionService sessionService) {
        this.userService = userService;
        this.sessionService = sessionService;
        logger.info("AdminUsersController initialized");
    }
