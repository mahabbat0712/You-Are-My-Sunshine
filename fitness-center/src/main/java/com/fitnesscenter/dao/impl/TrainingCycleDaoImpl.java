...
public class TrainingCycleDaoImpl extends AbstractDao<TrainingCycle, Long> implements TrainingCycleDao {
    ...
    private static final String FIND_BY_ID_SQL = 
            "SELECT id, name, description, duration_days, price, difficulty, sessions_per_week, active, created_at " +
    ...
    private static final String INSERT_SQL = 
            "INSERT INTO training_cycles (name, description, duration_days, price, difficulty, sessions_per_week, active, created_at) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    
    private static final String UPDATE_SQL = 
            "UPDATE training_cycles " +
            "SET name = ?, description = ?, duration_days = ?, price = ?, difficulty = ?, sessions_per_week = ?, active = ? " +
            "WHERE id = ?";
    ...
    private TrainingCycle insert(TrainingCycle trainingCycle) {
        ...
        Optional<Long> generatedId = updateAndGetGeneratedKey(INSERT_SQL,
                ...
                trainingCycle.getDifficulty(),
                trainingCycle.getSessionsPerWeek(),
